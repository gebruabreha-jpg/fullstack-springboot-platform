...
public final class NodeFailureActionsDocumentation {
    ...
    public static class K8sNodeBase implements K8sNodeApi {
        ...
        @Override
        public void restartKubelet() {
            navigator.getExtendedCli().sendAsync("sudo systemctl restart kubelet");
            Delay.sleep(Duration.ofSeconds(5));
        }

        @Override
        public void killKubeletProcess() {
            navigator.getExtendedCli().sendAsync("sudo systemctl stop kubelet");
            Delay.sleep(Duration.ofSeconds(2));
        }
        }
    ...
    public interface KubectlApi {
        ...
        default String getNodeStatus(String nodeName) {
            return "";
        }

        default String describeNode(String nodeName) {
            return "";
        }
    }
