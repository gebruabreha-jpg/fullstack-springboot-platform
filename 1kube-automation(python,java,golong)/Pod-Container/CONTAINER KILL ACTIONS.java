...
DELETED {
    ...
    public interface KubectlApi {
        ...
        String getPodStatus(String podName);

        String execInContainer(String podName, String containerName, String command);

        void patchPodReadinessProbe(String podName, boolean enabled);

        void failInitContainer(String podName);
